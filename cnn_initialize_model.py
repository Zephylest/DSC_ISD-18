...
def initialize_cnn_model(path_to_csv, hfirst_layer_neuron, hsecond_layer_neuron, save_path):
    # read clean csv data
...
def main():
    initialize_cnn_model('data/clean_data_without_result.csv', 64, 32, 'model/cnn_model_1.keras')
